...
import com.yj.ecard.ui.views.expendlistview.AbstractSlideExpandableListAdapter.OnItemExpandCollapseListener;
...
public class ActionSlideExpandableListView extends SlideExpandableListView {
	...
	public void setAdapter(ListAdapter adapter, int toggle_button_id, int expandable_view_id,
			OnItemExpandCollapseListener itemExpandCollapseListener) {
		...
		}, toggle_button_id, expandable_view_id, itemExpandCollapseListener);
	}
