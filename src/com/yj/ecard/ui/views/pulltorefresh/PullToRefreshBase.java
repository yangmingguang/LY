...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	public final void onRefreshComplete() {
		if (isRefreshing()) {
			setState(State.REFRESH_TO_RESET);
		}
	}
	...
	final void setState(State state, final boolean... params) {
		...
		case RESET:
			onReset();
			//LogUtil.getLogger().d("refresh", "RESET");
			break;
		case REFRESH_TO_RESET:
			onReset();
			break;
		case PULL_TO_REFRESH:
			onPullToRefresh();
			//LogUtil.getLogger().d("refresh", "PULL_TO_REFRESH");
			break;
		case RELEASE_TO_REFRESH:
			onReleaseToRefresh();
			//LogUtil.getLogger().d("refresh", "RELEASE_TO_REFRESH");
			break;
		case REFRESHING:
		case MANUAL_REFRESHING:
			onRefreshing(params[0]);
			//LogUtil.getLogger().d("refresh", "REFRESHING/MANUAL_REFRESHING");
			break;
		case OVERSCROLLING:
			// NO-OP
			break;
