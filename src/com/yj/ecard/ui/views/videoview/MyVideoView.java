package com.yj.ecard.ui.views.videoview;
...
public class MyVideoView extends SurfaceView implements MediaPlayerControl {
	...
	public void setReadyListener(OnReadyListener lst) {
		this.mOnReadyListener = lst;
	}
	...
	private MediaPlayer.OnBufferingUpdateListener mBufferingUpdateListener = new MediaPlayer.OnBufferingUpdateListener() {
		public void onBufferingUpdate(MediaPlayer mp, int percent) {
			...
			if (mOnReadyListener != null) {
				mOnReadyListener.onBufferingUpdate(mp, percent);
			}
		}
	};
