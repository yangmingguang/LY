/**   
* @Title: TabOverflowFragment.java
...
import com.yj.ecard.ui.adapter.ExchangeListAdapter;
...
public class TabOverflowFragment extends BaseFragment {

	private int pageIndex = 1;
	private ExchangeListAdapter mAdapter;
	private PullToRefreshListView mListView;
	private View rootView, loadingView, emptyView;
	private List<ExchangeBean> mList = new ArrayList<ExchangeBean>();

	public static Fragment newInstance(Bundle bundle) {
		TabOverflowFragment fragment = new TabOverflowFragment();
		if (bundle != null)
	...
	*/
	...
	private OnRefreshListener2<ListView> onRefreshListener = new OnRefreshListener2<ListView>() {
		...
		public void onPullDownToRefresh(PullToRefreshBase<ListView> refreshView) {
			mList = new ArrayList<ExchangeBean>();
			pageIndex = 1;
			loadAllData();
		}
	...
	*/
	private void loadAllData() {
		ExchangeTabManager.getInstance().getExchangeListData(context, handler, getSortId(), pageIndex);
	}
	...
	private WeakHandler handler = new WeakHandler(new Callback() {
		...
		public boolean handleMessage(Message msg) {
			...
			case MeTabManager.onSuccess:
				ExchangeListResponse response = (ExchangeListResponse) msg.obj;
