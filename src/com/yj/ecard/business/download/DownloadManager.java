package com.yj.ecard.business.download;
...
public class DownloadManager {
	...
	public void addNewDownload(String url, String fileName, String target, boolean autoResume, boolean autoRename,
		...
		HttpHandler<File> handler = http.download(url, target, autoResume, autoRename, new ManagerCallBack(
