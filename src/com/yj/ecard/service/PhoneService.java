...
public class PhoneService extends Service {
    ...
    private boolean isCallingFlag = false;
        ...
        public void onCallStateChanged(int state, String incomingNumber) {
            ...
            // 响铃
                case TelephonyManager.CALL_STATE_RINGING:
                    ...
                    FloatWindowManager.getInstance().showFloatView(context, incomingNumber, false, false);// 显示半屏悬浮窗
                    break;
                ...
                case TelephonyManager.CALL_STATE_IDLE:
                    if (incomingFlag || isCallingFlag) {
                        ...
                        FloatWindowManager.getInstance().showFloatView(context, incomingNumber, true, isCallingFlag); // 显示全屏悬浮窗
    ...
    class CallPhoneStateReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (intent.getAction().equals(Intent.ACTION_NEW_OUTGOING_CALL)) {
                ...
                // 显示半屏悬浮窗
                FloatWindowManager.getInstance().showFloatView(context, phoneNumber, false, true);
            }
        }
    }
